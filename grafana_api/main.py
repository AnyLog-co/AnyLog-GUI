...
def main(): 
    ...
    :optional arguments:
       ...
       -d,  --dashboard-name     DASHBOARD_NAME      Dashboard Title                     (default: test)
       -g,  --graph-title        GRAPH_TITLE         Graph pannel title                  
    ...
    parser.add_argument('-d',  '--dashboard-name',  type=str, default='test',                                                                         help='Dashboard Title') 
